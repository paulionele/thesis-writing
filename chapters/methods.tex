...
%	\begin{algorithm}[t]
%	  \caption{Simple Monte Carlo Algorithm}\label{smc}
%	  \begin{algorithmic}[1]
%	    %\Procedure{Monte Carlo}{$N,t_{\textrm{max}}$}\Comment{Necessary variables initialized.}
%	    
%	    \For{$i = 1,2,3,\cdots, N$}\Comment{Loop over all particles.}
%	    	\State $ rnd\gets \texttt{rand()} $ \Comment{Random number $ \in [0,1] $.}
%	    	\If{$ rnd < P_- $}
%	    	
%	    	
%	    \EndFor
